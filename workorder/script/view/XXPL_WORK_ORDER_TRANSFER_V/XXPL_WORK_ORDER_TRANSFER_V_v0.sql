  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXPM"."XXPL_WORK_ORDER_TRANSFER_V" ("WO_SCH_MAIN_HDR_ID", "INTERFACE_STATUS", "RESOURCETABLEID", "WOOPERATIONID", "WORKORDERID", "BASISTYPE", "RESOURCECODE", "REQUIREDUSAGE", "RESOURCESEQUENCENUMBER", "USAGERATE", "PLANNEDSTARTDATE", "PLANNEDCOMPLETIONDATE", "WOOPERATIONRESOURCEID", "PAYLOAD_TYPE") AS 
  select 
