...
import com.scm.shedule.RunSchedule;
...
public class RunApps extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RunApps</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RunApps at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            if (!Boolean.valueOf(request.getParameter("stop"))) {
                out.println("<h1>Service started successfully !!!</h1>");
            } else {
                out.println("<h1>Service  has been stopped successfully!!!</h1>");
            }
            out.println("</html>");
        }
    }
